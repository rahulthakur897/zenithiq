    ...
    <main className="services-page">
      ...
      <section className="services-banner-container">
        ...
        <div className="services-banner-content">
          <h3>Our Services</h3>
          <p>
            Elevate Your Business with Zenithiq's Expert Consultancy and IT
            Solutions
          </p>
          {/* <ul>
            <li>
      ...
      {data.map((item, index) => (
        <div
          key={item.id}
          className={`agriculture-container ${
            index % 2 === 0 ? "even" : "odd"
          }`}
        >
          {index % 2 === 0 ? (
